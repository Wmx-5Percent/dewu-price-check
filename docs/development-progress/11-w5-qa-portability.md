...
- [ ] `Q08.17` Coordinator 验证 #9 全部 release gate done 并生成候选 release SHA；当前阻塞为 `profiles/5.95.1-1101.json` 的 `pending-manual-redacted-evidence`、受控 live/第二台电脑证据，以及 2026-08-12 `emulator-5556` 未在线，不能进入 `R06.1`。
