...
| 活跃生产 Developer | 1（受管 MOD-07 任务，直接回传 Coordinator） |
...
| 长期 Coordinator | MOD-03 PR #29 已 squash merge、#7 closed；#8 已满足上游门禁并启动 Integration Developer |
...
| W3 / MOD-03 Frida Agent | #7 | PR #29 已 squash merge；Issue closed；synthetic Profile 仍 fail-closed | 是 |
