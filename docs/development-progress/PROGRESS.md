...
| 活跃生产 Developer | 0 |
| 活跃 QA | 0 |
| 活跃 Reviewer | 1（`MOD-04` / final concurrency review） |
| 长期 Coordinator | 等待新独立 Reviewer 复审 PR #20 的实际自适应并发 P1 修复 |
...
| W1 / MOD-04 Jobs | #3 | 实际窗口化并发 P1 已由 fresh QA 复验 PASS；当前为新独立 Reviewer | 否 |
