...
| 当前步骤 | `I07.14`（MOD-07 serial 输入校验 repair） |
| 活跃生产 Developer | 1（原 MOD-07 Developer 修复空/空格 serial） |
| 活跃 QA / Reviewer | 0 / 0 |
| 长期 Coordinator | Reviewer 发现空/空格 `--device` 可进入采集；完整 device-binding 安全修复继续 |
